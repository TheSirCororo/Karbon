...
interface DataView : Nameable {
    ...
    fun <T : DataSerializable> getSerializable(path: DataQuery, clazz: KClass<T>): T? = getSerializable(path, clazz.java)
    fun <T : DataSerializable> getSerializable(path: DataQuery, clazz: Class<T>): T?

    fun <T : DataSerializable> getSerializableList(path: DataQuery, clazz: KClass<T>): List<T>? = getSerializableList(path, clazz.java)
    ...
    fun <T : CatalogType> getCatalogTypeList(path: DataQuery, clazz: KClass<T>): List<T>? = getCatalogTypeList(path, clazz.java)
