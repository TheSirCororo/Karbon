...
class ImmutableKarbonListValue<E>(
    ...
    override fun set(index: Int, element: E): ListValue.Immutable<E> = modifyCollection { list -> list[index] = element }

    override fun with(value: List<E>): ListValue.Immutable<E> = key.valueConstructor.getRawImmutable(value).asImmutable()
