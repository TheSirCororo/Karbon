...
object DataProviderRegistry {
    val dataProviders = ConcurrentHashMap<Key<*>, DataProvider<*, *>>()
    ...
    fun getProviderLookup(dataHolderType: Class<*>): DataProviderLookup =
        dataProviderLookupCache.getOrPut(dataHolderType) {
            val map = dataProviders.keys().asSequence()
    ...
    fun <V : Value<E>, E> getProvider(key: Key<V>, dataHolderType: KClass<*>): DataProvider<V, E> =
        getProvider(key, dataHolderType.java)
    ...
    fun getAllProviders(dataHolderType: Class<*>): Collection<DataProvider<*, *>> =
        getProviderLookup(dataHolderType).allProviders
