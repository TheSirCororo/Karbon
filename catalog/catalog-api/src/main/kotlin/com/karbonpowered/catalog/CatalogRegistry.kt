...
interface CatalogRegistry {
    ...
    fun <T : CatalogType, E : T> register(typeClass: KClass<T>, suggestedId: String, supplier: Supplier<E>): CatalogRegistry

    fun <T : CatalogType, E : T> register(typeClass: Class<T>, suggestedId: String, supplier: Supplier<E>): CatalogRegistry
    fun <T : CatalogType, E : T> register(typeClass: KClass<T>, suppliers: Sequence<Pair<String, () -> E>>): CatalogRegistry
