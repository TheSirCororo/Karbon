...
import com.karbonpowered.karbon.item.inventory.KarbonContainerType
...
class KarbonCatalogRegistry : CatalogRegistry {
    ...
    override fun <T : CatalogType, E : T> register(typeClass: KClass<T>, suggestedId: String, supplier: Supplier<E>) = register(typeClass.java, suggestedId, supplier)
    override fun <T : CatalogType, E : T> register(typeClass: Class<T>, suggestedId: String, supplier: Supplier<E>) = apply {
    ...
    override fun <T : CatalogType, E : T> register(typeClass: KClass<T>, suppliers: Sequence<Pair<String, () -> E>>) = apply {
        suppliers.forEach {
