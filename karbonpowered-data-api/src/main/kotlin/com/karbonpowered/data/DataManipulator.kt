...
interface DataManipulator : CopyableValueContainer {
    ...
    interface Mutable : DataManipulator {
        ...
        fun copyFrom(
            valueContainer: ValueContainer<Any?, Any?>,
            overlap: MergeFunction<Value<Any>, Any>,
        ...
        fun copyFrom(valueContainer: ValueContainer<Any?, Any?>): Mutable =
            copyFrom(valueContainer, MergeFunction.replacementPreferred())
    ...
    companion object {
        ...
        @JvmStatic
        fun immutableOf(valueContainer: ValueContainer<Any?, Any?>): Immutable =
            loadService<Immutable.Factory>().of(valueContainer)
        ...
        @JvmStatic
        fun mutableOf(valueContainer: ValueContainer<Any?, Any?>): Mutable =
            loadService<Mutable.Factory>().of(valueContainer)
